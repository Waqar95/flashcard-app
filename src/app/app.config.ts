...
import { ReviewFlashcardComponent } from './review-flashcard/review-flashcard.component';
...
const routes: Routes = [
  ...
  { path: 'review', component: ReviewFlashcardComponent }, // Renders Review±FlashCardComponent on / review
];
